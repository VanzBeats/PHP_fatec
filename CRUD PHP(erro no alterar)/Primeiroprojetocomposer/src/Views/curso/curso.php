...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Cursos</h1>
        <a href="/curso/inserir" class="btn btn-primary">Novo Curso</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="/curso/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/curso/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
